...
def get_user_homepage_recommendations(user_id):
    ...
    # Remove duplicates
    top_picks = remove_duplicates(top_picks)
    genre_1_recs = remove_duplicates(genre_1_recs)
    genre_2_recs = remove_duplicates(genre_2_recs)
    shake_it_up_recs = remove_duplicates(shake_it_up_recs)
    return {
        'Top Picks': top_picks,
