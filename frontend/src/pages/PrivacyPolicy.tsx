...
function PrivacyPolicy() {
  ...
  const faqItems = [
    { question: "1. Information We Collect",answer: (
          <div style={{ textAlign: "left" }}>
            ...
            <ul className="list-disc ml-6">
              <li>
                <strong>Personal Data:</strong> When you register for an account, sign
                up for our newsletter, or make a purchase, we may collect personal
                information such as your name, email address, phone number, billing
                address, and payment details.
              </li>
              <li>
                <strong>Usage Data:</strong> We automatically collect data on how you
                access and use our website. This includes your IP address, browser
                type, the pages you visit, and the time spent on each page.
              </li>
              <li>
    ...
    { question: "3. Legal Basis for Processing Your Data", answer: (
        <div style={{ textAlign: "left" }}>
            <p>We process your data based on the following legal grounds:</p>
            <ul className="list-disc ml-6">
              <li>
                <strong>Consent:</strong> We process your data when you have given us
                consent, such as subscribing to our newsletter or accepting cookies.
              </li>
              <li>
                <strong>Contract:</strong> We process your data when necessary to
                fulfill a contract with you, such as processing orders or providing
                customer support.
              </li>
              <li>
                <strong>Legitimate Interests:</strong> We process your data to pursue
                our legitimate business interests, such as improving our website and
                services.
              </li>
            </ul>
        </div>
      )},
    { question: "4. Data Retention", answer: (
        <div style={{ textAlign: "left" }}>
    ...
    { question: "5. Your Data Protection Rights", answer: (
        <div style={{ textAlign: "left" }}>
         <p>As a data subject, you have the following rights under the GDPR:</p>
          <ul className="list-disc ml-6">
            ...
            <li>
              ...
              transfer of your personal data to another organization, under certain
              conditions.
            </li>
            <li>
              <strong>Right to Object:</strong> You can object to processing based
              on legitimate interests, direct marketing, or automated
              decision-making.
            </li>
          </ul>
          <p>
    ...
    { question: "6. Data Security", answer: (
        <div style={{ textAlign: "left" }}>
      ...
      { question: "7. Sharing Your Data", answer: (
        <div style={{ textAlign: "left" }}>
           <p>
            ...
            <ul className="list-disc ml-6">
              <li>
                ...
                website and services, such as payment processors, hosting providers,
                or email service providers.
              </li>
              <li>
                <strong>Legal Requirements:</strong> We may disclose your information
                if required to do so by law or to protect our legal rights.
              </li>
            </ul>
        </div>
      ) },
      { question: "8. International Transfers", answer: (
        <div style={{ textAlign: "left" }}>
        ...
        <div className="container py-5">
          <div className="row justify-content-center">
            <div className="col-lg-10">
              ...
              <div>
              <p style={{ color: 'black' }}>
                At CineNiche, we are committed to protecting and respecting your
                privacy. This Privacy Policy explains how we collect, use, disclose, and
                safeguard your personal information when you visit our website
                (www.cineniche.com), use our services, or interact with us in other
                ways. By accessing or using our website, you agree to the terms outlined
